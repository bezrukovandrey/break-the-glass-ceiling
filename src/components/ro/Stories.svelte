...
<div class="bg-gray-900 text-white flex flex-col">
   <h1 class="text-xl lg:text-xxl font-bold tracking-tight flex justify-center items-center my-10">Povești</h1>
 </div>
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
     {#each volunteers as volunteer}
       <div class="bg-darkPurple p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
         ...
         <p class="mt-2 text-gray-300">{volunteer.text_ro}</p>
...
{:else }
<div class="py-48 text-center text-white bg-lightPurple">Fără povești în acest moment</div>
{/if}
